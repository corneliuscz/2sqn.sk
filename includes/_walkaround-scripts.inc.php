...
$(document).ready(function(){
    ...
    htmlNotes += '<div id="tip"><span><?php echo $app->tr['walkaround']['controls']; ?></span><img src="http://www.2sqn.sk/assets/img/w-leva.png" onclick="$(\'.threesixty\').prevFrame();" class="sep"><img src="http://www.2sqn.sk/assets/img/w-prava.png" onclick="$(\'.threesixty\').nextFrame();"></div>';
